...
class perfilesController extends Controller {
    ...
    public function perfilesMain() {
        ...
        $OK = $admin->opcion_perfiles('menuPerfil',Session::get('idPerfil'));
        
        if($OK === true){
            //listado de los usuarios actuales
            $arResult = Perfil::where('status','=','1')->get();
            
            return view('admin.perfilesMain')->with('arResult',$arResult)
; 
        }else{
