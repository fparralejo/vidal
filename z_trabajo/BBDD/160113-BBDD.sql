...
-- Volcando datos para la tabla vidal.anuncio: ~2 rows (aproximadamente)
...
INSERT IGNORE INTO `anuncio` (`idAnuncio`, `idUsuario`, `idContacto`, `idModelo`, `kilometros`, `color`, `precio`, `tipo_cambio`, `observaciones`, `youtube_url`, `fechaStatus`, `status`) VALUES
	(1, 0, 1, 58, 37500, 'gris metalizado', 2500, 'Automatico', 'automovil potente y muy cuidado', 'https://www.youtube.com/embed/zZxvYy5-ekI', '2016-01-10 18:36:47', 1),
	(2, 5, 0, 15, 77500, 'Rojo plateadillo', 2557, 'Manual', 'anuncio de un coche de color rojo', 'https://www.youtube.com/embed/lzhIPnFhnko', '2016-01-13 19:48:20', 1);
...
-- Volcando datos para la tabla vidal.contacto: ~2 rows (aproximadamente)
